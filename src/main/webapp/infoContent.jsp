...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#import_btn").click(function() {
			...
			if(filename==""){
				...
				url = "infoContentServlet?opType=importFile";
				importFile();
			}
	    });
		...
		$("#export_btn").click(function() {
			$.messager.confirm('确认对话框', '确认下载?', function(r){
				if (r){
					url = "infoContentServlet?opType=exportFile&filename=infoContent.xls";
					exportFile();
					/* 
		...
		$("#dg").datagrid({
			...
			columns:[[
				...
				{field:'tId',width:100,align:'center',title:'内容模版'},
	...
	function update() {
		...
		url = "infoContent/update?id="+array[0].id;
		openDialogForm();
