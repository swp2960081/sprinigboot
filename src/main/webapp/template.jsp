	...
	$(function(){
		...
		$("#import_btn").click(function() {
			...
			if(filename==""){
				...
				url = "templateServlet?opType=importFile";
				importFile();
			}
	    });
		...
		$("#export_btn").click(function() {
			$.messager.confirm('确认对话框', '确认下载?', function(r){
				if (r){
					url = "templateServlet?opType=exportFile&filename=template.xls";
					exportFile();
					/* 
		...
		$("#dg").datagrid({
			...
			columns:[[
				...
				{field:'name',width:100,align:'center',title:'模版名称'},
				{field:'content',width:100,align:'center',title:'内容'},
				{field:'type',width:100,align:'center',title:'类型',formatter:function(value,row,index){
					if(value==1){
						return "图片";
					}else if(value==2){
						return "文字";
				...
				{field:'userId',width:100,align:'center',title:'创建人'},
		...
		<form id="Form" method="post">
			<table style="margin: 0 auto;">
				...
				<tr>
					...
					<td><input type="radio" name="type" value="1" checked="checked">图片<br/>
						<input type="radio" name="type" value="2">文字<br/>
						<input type="radio" name="type" value="3">图文混合<br/>
				</tr>
				<tr>
					<td class="right">备注：</td>
					<td><input name="remark" class="easyui-textbox" data-options="required:true"></td>
				</tr>
				<tr>
